...
export function displayMediaData(mediaData: any) {
  ...
  appEl.innerHTML = `
    ...
    <select id="media-type-filter" class="mr-4 p-2 bg-gray-700 text-white rounded focus:outline-none">
      ...
      <button id="reset-filters" class="ml-4 p-2 bg-blue-500 text-white cursor-pointer rounded focus:outline-none">Reset Filters</button>
    </div>
